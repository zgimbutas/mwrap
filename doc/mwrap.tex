...
\item {\tt -i8} tells \mwrap\ to convert {\tt int}, {\tt long}, {\tt
  uint}, {\tt ulong} types to {\tt int64\_t}, {\tt uint64\_t}. This is
  convenient if {\tt -i8}, {\tt -fdefault-integer-8} or {\tt
    -finteger-4-integer-8} flags are used by a Fortran compiler.
